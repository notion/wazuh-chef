default['wazuh-elastic']['ssl_enabled'] = false
default['wazuh-elastic']['java_install'] = false
default['wazuh-elastic']['elastic_stack_version'] = '6.5.4'
default['wazuh-elastic']['wazuh_app_version'] = "3.7.2_6.5.4"
